...
void USettingsManager::RegisterIntCVarSetting(FName Name, int32 DefaultValue, const FString& Help)
{
	...
	FString ConfigValue = Get()->GetConfigValue(Name);
	int32 InitValue = ConfigValue.IsEmpty() ? DefaultValue : FCString::Atoi(*ConfigValue);
...
void USettingsManager::RegisterFloatCVarSetting(FName Name, float DefaultValue, const FString& Help)
{
	...
	FString ConfigValue = Get()->GetConfigValue(Name);
	float InitValue = ConfigValue.IsEmpty() ? DefaultValue : FCString::Atof(*ConfigValue);
...
void USettingsManager::RegisterStringCVarSetting(FName Name, const FString& DefaultValue, const FString& Help)
{
	...
	FString ConfigValue = Get()->GetConfigValue(Name);
	FString InitValue = ConfigValue.IsEmpty() ? DefaultValue : ConfigValue;
...
{
	Scalability::FQualityLevels State = Scalability::BenchmarkQualityLevels();
