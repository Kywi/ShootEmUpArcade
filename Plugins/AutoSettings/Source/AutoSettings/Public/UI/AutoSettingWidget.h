...
protected:
	...
	bool IsUpdatingSettingSelection() { return bUpdatingSettingSelection; }
...
private:
	...
	FString ProcessIncomingValue(FString Value);
	...
	FString ProcessOutgoingValue(FString Value, bool bRecombineWithConfigValue = false);
